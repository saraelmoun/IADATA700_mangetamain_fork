...
class MangetamainLogger:
    ...
    def __init__(self, name: str = "mangetamain", level: str = "INFO", 
                 debug_log_file: Optional[Path] = None, error_log_file: Optional[Path] = None):
        """
    ...
    def _setup_handlers(self, debug_log_file: Optional[Path] = None, error_log_file: Optional[Path] = None):
...
def setup_logging(level: str = "INFO", debug_log_file: Optional[Path] = None, 
                 error_log_file: Optional[Path] = None) -> MangetamainLogger:
    """
